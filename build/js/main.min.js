...
/* harmony import */ var _modules_init_slider_news__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-slider-news */ "./js/modules/init-slider-news.js");
/* harmony import */ var _modules_init_slider_reviews__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/init-slider-reviews */ "./js/modules/init-slider-reviews.js");
/* harmony import */ var _modules_init_toggle_class_card__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/init-toggle-class-card */ "./js/modules/init-toggle-class-card.js");
/* harmony import */ var _modules_init_tabs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/init-tabs */ "./js/modules/init-tabs.js");
/* harmony import */ var _modules_init_resize_nav__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/init-resize-nav */ "./js/modules/init-resize-nav.js");
/* harmony import */ var _modules_init_more_nav__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/init-more-nav */ "./js/modules/init-more-nav.js");
/* harmony import */ var _modules_init_video_play__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/init-video-play */ "./js/modules/init-video-play.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_init_slider_news__WEBPACK_IMPORTED_MODULE_4__["initSliderNews"])();
    Object(_modules_init_slider_reviews__WEBPACK_IMPORTED_MODULE_5__["initSliderReviews"])();
    Object(_modules_init_toggle_class_card__WEBPACK_IMPORTED_MODULE_6__["initToggleClassCard"])();
    Object(_modules_init_tabs__WEBPACK_IMPORTED_MODULE_7__["initTabs"])();
    Object(_modules_init_resize_nav__WEBPACK_IMPORTED_MODULE_8__["initNavModules"])();
    Object(_modules_init_more_nav__WEBPACK_IMPORTED_MODULE_9__["initMoreNav"])();
    Object(_modules_init_video_play__WEBPACK_IMPORTED_MODULE_10__["initVideoPlay"])();
  });
});
...
/***/ "./js/modules/init-more-nav.js":
/*!*************************************!*\
  !*** ./js/modules/init-more-nav.js ***!
  \*************************************/
/*! exports provided: initMoreNav */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initMoreNav", function() { return initMoreNav; });
var initMoreNav = function initMoreNav() {
  window.addEventListener('resize', function () {
    var width = document.body.clientWidth;
    if (width >= 1024 && width < 1280) {
      var nav = document.querySelector('.main-nav__list');
      var itemList = Array.from(document.querySelectorAll('.main-nav__item'));
      var widthList = 0;
      for (var i = 0; i < itemList.length; i++) {
        widthList += itemList[i].offsetWidth;
      }
      var navWidth = nav.dataset.navWidth;
      var moreList = document.querySelector('.more__list');
...
/***/ "./js/modules/init-resize-nav.js":
/*!***************************************!*\
  !*** ./js/modules/init-resize-nav.js ***!
  \***************************************/
/*! exports provided: initNavModules */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initNavModules", function() { return initNavModules; });
/* harmony import */ var _vendor_observers_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../vendor/observers.js */ "./js/vendor/observers.js");
/* harmony import */ var _set_nav_width_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./set-nav-width.js */ "./js/modules/set-nav-width.js");


var initNavModules = function initNavModules() {
  Object(_set_nav_width_js__WEBPACK_IMPORTED_MODULE_1__["setNavWidth"])();
  _vendor_observers_js__WEBPACK_IMPORTED_MODULE_0__["resizeObserver"].subscribe(_set_nav_width_js__WEBPACK_IMPORTED_MODULE_1__["setNavWidth"]);
};

/***/ }),

/***/ "./js/modules/init-slider-news.js":
/*!****************************************!*\
  !*** ./js/modules/init-slider-news.js ***!
  \****************************************/
/*! exports provided: initSliderNews */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initSliderNews", function() { return initSliderNews; });
...
var initSliderNews = function initSliderNews() {
  if (document.querySelector('.news__slider')) {
    // eslint-disable-next-line no-new, no-unused-vars, no-undef
    var swp = new Swiper('.news__slider', {
      observer: true,
      speed: 1e3,
      infinite: false,
      slidesPerView: 4,
...
/***/ "./js/modules/init-slider-reviews.js":
/*!*******************************************!*\
  !*** ./js/modules/init-slider-reviews.js ***!
  \*******************************************/
/*! exports provided: initSliderReviews */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var initSliderReviews = function initSliderReviews() {
  if (document.querySelector('.reviews__content')) {
    // eslint-disable-next-line no-new, no-unused-vars, no-undef
    var swp = new Swiper('.reviews__content', {
      observer: true,
      slidesPerView: 1,
      slidePerGroup: 1,
      speed: 1e3,
...
/***/ "./js/modules/init-toggle-class-card.js":
/*!**********************************************!*\
  !*** ./js/modules/init-toggle-class-card.js ***!
  \**********************************************/
/*! exports provided: initToggleClassCard */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initToggleClassCard", function() { return initToggleClassCard; });
var cards = document.querySelectorAll('[data-card-horizontal]');
var initToggleClassCard = function initToggleClassCard() {
  if (cards.length === 0) {
    return;
  }
  window.addEventListener('resize', function () {
...
/***/ "./js/modules/init-video-play.js":
/*!***************************************!*\
  !*** ./js/modules/init-video-play.js ***!
  \***************************************/
/*! exports provided: initVideoPlay */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var initVideoPlay = function initVideoPlay() {
  var videoPlayer = document.querySelector('[data-video="video-player"]');
  if (!videoPlayer) {
    return;
  }
  ...
  body.append(tag);
  var initPlayer = function initPlayer(playerEl) {
    var overlay = videoPlayer.querySelector('[data-video="overlay"]');
    var button = videoPlayer.querySelector('[data-video="button-play"]');
  ...
  window.onYouTubePlayerAPIReady = function () {
    var playerEl = videoPlayer.querySelector('[data-video="player"]');
    initPlayer(playerEl);
  };
};
...
/***/ "./js/modules/set-nav-width.js":
/*!*************************************!*\
  !*** ./js/modules/set-nav-width.js ***!
  \*************************************/
/*! exports provided: setNavWidth */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setNavWidth", function() { return setNavWidth; });
var setNavWidth = function setNavWidth() {
  var nav = document.querySelector('.main-nav__list');
  if (!nav) {
...
/***/ "./js/vendor/observers.js":
/*!********************************!*\
  !*** ./js/vendor/observers.js ***!
  \********************************/
/*! exports provided: EventObserver, resizeObserver, clickObserver */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "clickObserver", function() { return clickObserver; });
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
