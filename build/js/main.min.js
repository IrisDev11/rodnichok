...
/* harmony import */ var _modules_init_video_play__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/init-video-play */ "./js/modules/init-video-play.js");
...
/* harmony import */ var _modules_init_content_modal__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/init-content-modal */ "./js/modules/init-content-modal.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_init_video_play__WEBPACK_IMPORTED_MODULE_7__["initVideoPlay"])();
    Object(_modules_init_tabs__WEBPACK_IMPORTED_MODULE_8__["initTabs"])();
    Object(_modules_init_accordion__WEBPACK_IMPORTED_MODULE_9__["initAccordions"])();
    Object(_modules_init_content_modal__WEBPACK_IMPORTED_MODULE_10__["initContentModal"])();
  });
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initContentModal", function() { return initContentModal; });
var initContentModal = function initContentModal() {
  var btnOpenModals = document.querySelectorAll('.card-documentation__btn');
  var modalBlock = document.querySelector('[data-modal="documentation"]');
  if (!modalBlock) {
    return;
  }
  ...
  var modalImg = modalBlock.querySelector('img');
  btnOpenModals.forEach(function (item) {
    item.addEventListener('click', function () {
      // const title = item.querySelector('[data-modal-title]');
      // const text = item.querySelector('[data-modal-text]');
      var img = item.dataset.modalImage;

      // modalTitle.textContent = title.textContent;
      // modalText.textContent = text.textContent;
      modalImg.src = "img/documentation/".concat(img, "@2x.png");
    });
  });
};
